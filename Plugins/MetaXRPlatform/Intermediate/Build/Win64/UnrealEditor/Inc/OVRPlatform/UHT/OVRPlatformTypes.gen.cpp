...
template<> OVRPLATFORM_API UScriptStruct* StaticStruct<FOvrVariant>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_LuaTemplate_Plugins_MetaXRPlatform_Source_OVRPlatform_Public_OVRPlatformTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_LuaTemplate_Plugins_MetaXRPlatform_Source_OVRPlatform_Public_OVRPlatformTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_LuaTemplate_Plugins_MetaXRPlatform_Source_OVRPlatform_Public_OVRPlatformTypes_h_2447567876(TEXT("/Script/OVRPlatform"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_LuaTemplate_Plugins_MetaXRPlatform_Source_OVRPlatform_Public_OVRPlatformTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_LuaTemplate_Plugins_MetaXRPlatform_Source_OVRPlatform_Public_OVRPlatformTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
