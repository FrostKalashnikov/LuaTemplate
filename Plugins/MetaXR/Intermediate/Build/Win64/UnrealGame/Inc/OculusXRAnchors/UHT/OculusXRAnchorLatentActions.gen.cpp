...
void UOculusXRAnchorLaunchCaptureFlow::FOculusXRAnchorCaptureFlowFinished_DelegateWrapper(const FMulticastScriptDelegate& OculusXRAnchorCaptureFlowFinished)
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_OculusXRAnchors_Public_OculusXRAnchorLatentActions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusXRAsyncAction_CreateSpatialAnchor, UOculusXRAsyncAction_CreateSpatialAnchor::StaticClass, TEXT("UOculusXRAsyncAction_CreateSpatialAnchor"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_CreateSpatialAnchor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_CreateSpatialAnchor), 501310722U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_EraseAnchor, UOculusXRAsyncAction_EraseAnchor::StaticClass, TEXT("UOculusXRAsyncAction_EraseAnchor"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_EraseAnchor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_EraseAnchor), 2695175316U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_SaveAnchor, UOculusXRAsyncAction_SaveAnchor::StaticClass, TEXT("UOculusXRAsyncAction_SaveAnchor"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_SaveAnchor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_SaveAnchor), 3386980232U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_SaveAnchorList, UOculusXRAsyncAction_SaveAnchorList::StaticClass, TEXT("UOculusXRAsyncAction_SaveAnchorList"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_SaveAnchorList, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_SaveAnchorList), 2658460672U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_QueryAnchors, UOculusXRAsyncAction_QueryAnchors::StaticClass, TEXT("UOculusXRAsyncAction_QueryAnchors"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_QueryAnchors, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_QueryAnchors), 1125688946U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_SetAnchorComponentStatus, UOculusXRAsyncAction_SetAnchorComponentStatus::StaticClass, TEXT("UOculusXRAsyncAction_SetAnchorComponentStatus"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_SetAnchorComponentStatus, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_SetAnchorComponentStatus), 422206021U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_SetComponentStatus, UOculusXRAsyncAction_SetComponentStatus::StaticClass, TEXT("UOculusXRAsyncAction_SetComponentStatus"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_SetComponentStatus, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_SetComponentStatus), 1048267463U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_ShareAnchors, UOculusXRAsyncAction_ShareAnchors::StaticClass, TEXT("UOculusXRAsyncAction_ShareAnchors"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_ShareAnchors, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_ShareAnchors), 299494338U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_SaveAnchors, UOculusXRAsyncAction_SaveAnchors::StaticClass, TEXT("UOculusXRAsyncAction_SaveAnchors"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_SaveAnchors, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_SaveAnchors), 813414948U) },
		{ Z_Construct_UClass_UOculusXRAsyncAction_EraseAnchors, UOculusXRAsyncAction_EraseAnchors::StaticClass, TEXT("UOculusXRAsyncAction_EraseAnchors"), &Z_Registration_Info_UClass_UOculusXRAsyncAction_EraseAnchors, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRAsyncAction_EraseAnchors), 3464037343U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OculusXR_Source_OculusXRAnchors_Public_OculusXRAnchorLatentActions_h_1456444476(TEXT("/Script/OculusXRAnchors"),
