...
void FVROnMeleeInvalidHitSignature_DelegateWrapper(const FMulticastScriptDelegate& VROnMeleeInvalidHitSignature, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, FHitResult const& Hit)
{
	...
	UGS_Melee::~UGS_Melee() {}
	struct Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGS_Melee, UGS_Melee::StaticClass, TEXT("UGS_Melee"), &Z_Registration_Info_UClass_UGS_Melee, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGS_Melee), 105319503U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_3414490508(TEXT("/Script/VRExpansionPlugin"),
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Melee_h_Statics::EnumInfo));
