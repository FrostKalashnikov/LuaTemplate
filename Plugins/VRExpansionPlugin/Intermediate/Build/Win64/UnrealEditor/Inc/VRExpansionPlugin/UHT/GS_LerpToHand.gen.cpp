...
void FVRLerpToHandFinishedSignature_DelegateWrapper(const FMulticastScriptDelegate& VRLerpToHandFinishedSignature)
{
	...
	struct Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_LerpToHand_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_LerpToHand_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGS_LerpToHand, UGS_LerpToHand::StaticClass, TEXT("UGS_LerpToHand"), &Z_Registration_Info_UClass_UGS_LerpToHand, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGS_LerpToHand), 2913365831U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_LerpToHand_h_2279671157(TEXT("/Script/VRExpansionPlugin"),
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_LerpToHand_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_LerpToHand_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
