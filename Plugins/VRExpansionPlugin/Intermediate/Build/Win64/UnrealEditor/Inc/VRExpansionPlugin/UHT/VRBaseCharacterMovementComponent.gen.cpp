...
void FVROnPerformClimbingStepUp_DelegateWrapper(const FMulticastScriptDelegate& VROnPerformClimbingStepUp, FVector FinalStepUpLocation)
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UVRBaseCharacterMovementComponent_SetCharacterToNewGravity_Statics::Function_MetaDataParams[] = {
		{ "Category", "BaseVRCharacterMovementComponent|Wall Walking" },
#if !UE_BUILD_SHIPPING
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVRBaseCharacterMovementComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UVRBaseCharacterMovementComponent_SetAutoOrientToFloorNormal, "SetAutoOrientToFloorNormal" }, // 1732707462
		{ &Z_Construct_UFunction_UVRBaseCharacterMovementComponent_SetCharacterToNewGravity, "SetCharacterToNewGravity" }, // 3134524675
	...
	struct Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBaseCharacterMovementComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBaseCharacterMovementComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVRBaseCharacterMovementComponent, UVRBaseCharacterMovementComponent::StaticClass, TEXT("UVRBaseCharacterMovementComponent"), &Z_Registration_Info_UClass_UVRBaseCharacterMovementComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVRBaseCharacterMovementComponent), 1606056903U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBaseCharacterMovementComponent_h_1219627537(TEXT("/Script/VRExpansionPlugin"),
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBaseCharacterMovementComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBaseCharacterMovementComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
