...
void FVRPRCBeginYawRotationEventSignature_DelegateWrapper(const FMulticastScriptDelegate& VRPRCBeginYawRotationEventSignature)
{
	...
	struct Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_ParentRelativeAttachmentComponent_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_ParentRelativeAttachmentComponent_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_ParentRelativeAttachmentComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_ParentRelativeAttachmentComponent_h_636694309(TEXT("/Script/VRExpansionPlugin"),
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_ParentRelativeAttachmentComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_ParentRelativeAttachmentComponent_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_ParentRelativeAttachmentComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_ParentRelativeAttachmentComponent_h_Statics::EnumInfo));
