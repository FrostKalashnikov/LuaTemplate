...
template<> VREXPANSIONPLUGIN_API UScriptStruct* StaticStruct<FGunTools_AdvSecondarySettings>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGS_GunTools_Statics::NewProp_VirtualStockSettings = { "VirtualStockSettings", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGS_GunTools, VirtualStockSettings), Z_Construct_UScriptStruct_FBPVirtualStockSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGS_GunTools_Statics::NewProp_VirtualStockSettings_MetaData), Z_Construct_UClass_UGS_GunTools_Statics::NewProp_VirtualStockSettings_MetaData) }; // 406285011
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_GunTools_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_GunTools_h_Statics::ScriptStructInfo[] = {
		{ FBPVirtualStockSettings::StaticStruct, Z_Construct_UScriptStruct_FBPVirtualStockSettings_Statics::NewStructOps, TEXT("BPVirtualStockSettings"), &Z_Registration_Info_UScriptStruct_BPVirtualStockSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBPVirtualStockSettings), 406285011U) },
		{ FGunTools_AdvSecondarySettings::StaticStruct, Z_Construct_UScriptStruct_FGunTools_AdvSecondarySettings_Statics::NewStructOps, TEXT("GunTools_AdvSecondarySettings"), &Z_Registration_Info_UScriptStruct_GunTools_AdvSecondarySettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGunTools_AdvSecondarySettings), 578674246U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_GunTools_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGS_GunTools, UGS_GunTools::StaticClass, TEXT("UGS_GunTools"), &Z_Registration_Info_UClass_UGS_GunTools, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGS_GunTools), 1617430950U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_GunTools_h_787245410(TEXT("/Script/VRExpansionPlugin"),
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_GunTools_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_GunTools_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_GunTools_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LuaTemplate_Plugins_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_GunTools_h_Statics::ScriptStructInfo),
		nullptr, 0);
